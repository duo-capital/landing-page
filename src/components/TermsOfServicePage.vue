  ...
  <div>
    <v-container>
      <v-main class="mt-60">
        ...
        <p>These Terms of Service were last updated on 1 July 2022.</p>
        ...
        <p>
          ...
          restrictions or the Terms of Service, and may be terminated by Duo
          Capital LLC at any time.
        </p>
        <h3>Liability</h3>
        <p>
        ...
        <p>
          ...
          with the laws of New Jersey. You irrevocably submit to the exclusive
